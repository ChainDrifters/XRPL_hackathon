    ...
    <div className="phone">
      ...
      <div className="scroll-area">
        <div className="summary-card">
          <div className="label">받을 수 있는 환급 합계</div>
          <div className="amount">324,500<span className="currency">원</span></div>
          <div className="row">
            <div className="stat">
              <div className="stat-label">진행 중</div>
              <div className="stat-value">2건 · 28,800원</div>
            </div>
            <div className="stat">
        ...
        <div className="case-card">
          ...
          <div className="progress">
            <div className="seg done" /><div className="seg done" /><div className="seg done" />
            <div className="seg" /><div className="seg" />
          </div>
          <div className="step-text">키오스크에서 확인 중이에요</div>
        </div>
        ...
        <div className="case-card">
          <div className="top">
            ...
            <div className="pill success">받기 →</div>
          </div>
