...
import { Signal, BatteryMedium, ChevronLeft, MoreHorizontal, Settings, Home, Banknote, ArrowDown, ArrowUp, Link, Upload, FileText, Lock } from 'lucide-react'
  ...
  return (
    <div className="phone">
      ...
      <div className="nav-bar">
        ...
        <div className="right"><span className="icon"><MoreHorizontal size={20}/></span></div>
      </div>
      ...
      <div className="scroll-area">
        ...
        <div style={{ background: 'var(--success-light)', borderRadius: 12, padding: '12px 14px', marginBottom: 12, display: 'flex', gap: 10, alignItems: 'flex-start' }}>
          <span style={{ display:'flex', alignItems:'center' }}><Lock size={16}/></span>
          <div>
        ...
        <div className="info-card" style={{ padding: '4px 18px' }}>
          <div className="tx-item">
            <div className="ic"><ArrowDown size={16}/></div>
          ...
          <div className="tx-item out">
            <div className="ic"><ArrowUp size={16}/></div>
        ...
        <div className="info-card">
          <div className="advanced-row">
            <div className="ic"><Link size={20}/></div>
