...
import { Signal, BatteryMedium, Bell, Settings, Home, Banknote, Store, ShoppingBag, QrCode, ClipboardList } from 'lucide-react'
  ...
  return (
    <div className="phone">
      ...
      <div className="nav-bar">
        ...
        <div className="right"><span className="icon"><Bell size={18}/></span><span className="icon"><Settings size={18}/></span></div>
      </div>
      ...
      <div className="scroll-area">
        <div className="today-total-card">
          ...
          <div className="today-item-list">
            <div className="today-item">
              <div className="left"><span className="ic"><ShoppingBag size={16}/></span><span className="name">올리브영</span></div>
              <span className="usd">13,700원</span>
            </div>
            <div className="today-item">
              <div className="left"><span className="ic"><Store size={16}/></span><span className="name">롯데백화점</span></div>
        ...
        <div className="qr-issue-row" style={{ cursor: 'pointer' }} onClick={() => navigate('/qr-home')}>
          <span className="ic"><QrCode size={20}/></span>
          <div className="body">
      ...
      <div className="bottom-nav">
        <div className="bn-item" style={{ cursor: 'pointer' }} onClick={() => navigate('/balance-home')}><span className="icon"><Home size={20}/></span><span className="label">홈</span></div>
        ...
        <div className="bn-item active"><span className="icon"><ClipboardList size={20}/></span><span className="label">활동</span></div>
